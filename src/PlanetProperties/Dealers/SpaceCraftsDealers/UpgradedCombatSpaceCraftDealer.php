...
use Hyperdrive\Products\Spacecrafts\CombatSpaceCrafts\LighterCombatSpaceCraft;

class UpgradedCombatSpaceCraftDealer extends SpacecraftDealer
{
    protected function createProduct(): Product
    {
        return new LighterCombatSpaceCraft(
    ...
    {
        return "Buy upgraded Combat space craft, with basic equipment. Price: "
            . round(PriceList::UpgradedCombatSpaceCraftPrice,2);
    }
}