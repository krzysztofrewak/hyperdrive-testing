...
class UpgradedHybridSpaceCraftDealer extends SpacecraftDealer
{
    ...
    {
        return "Buy upgraded hybrid space craft, with basic equipment. Price: "
            . round(PriceList::UpgradedHybridSpaceCraftPrice,2);
    }
}